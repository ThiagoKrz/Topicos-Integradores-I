...
if ($id) {
    $cliente = $pdo->query("select * from cliente where id = " . $id)
        ->fetch();
}
?>
<!DOCTYPE html>
                            ...
                            <div class="col-12">
                                <form method="post" id="frmcliente">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="telefone" name="telefone" placeholder="Digite seu Telefone!" required value="<? echo isset($cliente['telefone']) ? $cliente['telefone'] : ''; ?>">
                                    </div>
                                </form>
                            </div>
                        </div>
